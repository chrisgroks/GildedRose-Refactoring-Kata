...
(defun update-item (item)
  (let* ((is-conjured (string:prefix (item-name item) "Conjured"))
         (item (if (and (not (string:equal (item-name item)
                                           "Aged Brie"))
                 ...
                 (if (> (item-quality item) 0)
                   (if (not (string:equal (item-name item)
                     ...
                     (let ((item (set-item-quality item (- (item-quality item) 1))))
                       (if (and is-conjured (> (item-quality item) 0))
